 ...
 */
class Analytify_Google_Http_Batch
{
  ...
  public function __construct(Analytify_Google_Client $client, $boundary = false)
  {
    $this->client = $client;
  ...
  public function add(Analytify_Google_Http_Request $request, $key = false)
  {
    if (false == $key) {
      $key = mt_rand();
    }
  ...
  public function execute()
  {
    ...
    /** @var Analytify_Google_Http_Request $req */
    ...
    $httpRequest = new Analytify_Google_Http_Request($url, 'POST');
