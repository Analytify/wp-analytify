  ...
  public function __call($name, $arguments) {
    ...
    if ($postBody) {
      ...
      if (isset($contentType) && $contentType) {
        ...
        $contentTypeHeader['content-length'] = Analytify_Google_Utils::getStrLen($postBody);
      }
      $httpRequest->setRequestHeaders($contentTypeHeader);
    }

    $httpRequest = Analytify_Google_Client::$auth->sign($httpRequest);
    if (Analytify_Google_Client::$useBatch) {
      return $httpRequest;
    }
