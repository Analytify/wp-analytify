...
require_once ANALYTIFY_LIB_PATH . 'Google/Http/MediaFileUpload.php';
 ...
 *
 */
class Analytify_Google_Service_Resource
{
  ...
  /** @var Analytify_Google_Service $service */
  private $service;

  /** @var Analytify_Google_Client $client */
  private $client;
  ...
  public function call($name, $arguments, $expected_class = null)
  {
    ...
    $url = Analytify_Google_Http_REST::createRequestUri(
        $servicePath,
        $method['path'],
        $parameters
    );
    ...
    if (isset($parameters['data']) &&
      ...
      $mfu = new Analytify_Google_Http_MediaFileUpload(
          $this->client,
          $httpRequest,
