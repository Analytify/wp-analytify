 ...
 * @author Google, Inc.
 */
class Analytify_Google_Service_Customsearch extends Analytify_Google_Service
{
  ...
  public function __construct(Analytify_Google_Client $client)
  {
    ...
    $this->cse = new Analytify_Google_Service_Customsearch_Cse_Resource(
        $this,
        $this->serviceName,
        'cse',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $customsearchService = new Analytify_Google_Service_Customsearch(...);
 *   $cse = $customsearchService->cse;
 *  </code>
 */
class Analytify_Google_Service_Customsearch_Cse_Resource extends Analytify_Google_Service_Resource
{
   ...
   * Controls whether to include or exclude results from the site named in the as_sitesearch
    * parameter
   * @return Analytify_Google_Service_Customsearch_Search
   */
  public function listCse($q, $optParams = array())
  {
    $params = array('q' => $q);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Analytify_Google_Service_Customsearch_Search");
  }
}
...
class Analytify_Google_Service_Customsearch_Context extends Analytify_Google_Collection
{
  protected $facetsType = 'Analytify_Google_Service_Customsearch_ContextFacets';
...
class Analytify_Google_Service_Customsearch_ContextFacets extends Analytify_Google_Model
{
  public $anchor;
  public $label;
  public $labelWithOp;
...
class Analytify_Google_Service_Customsearch_Promotion extends Analytify_Google_Collection
{
  protected $bodyLinesType = 'Analytify_Google_Service_Customsearch_PromotionBodyLines';
  protected $bodyLinesDataType = 'array';
  public $displayLink;
  public $htmlTitle;
  protected $imageType = 'Analytify_Google_Service_Customsearch_PromotionImage';
  ...
  public function setImage(Analytify_Google_Service_Customsearch_PromotionImage $image)
  {
    $this->image = $image;
  }
...
class Analytify_Google_Service_Customsearch_PromotionBodyLines extends Analytify_Google_Model
{
  public $htmlTitle;
  public $link;
  public $title;
...
class Analytify_Google_Service_Customsearch_PromotionImage extends Analytify_Google_Model
{
  public $height;
  public $source;
  public $width;
...
class Analytify_Google_Service_Customsearch_Query extends Analytify_Google_Model
{
  public $count;
  public $cr;
  public $cref;
...
class Analytify_Google_Service_Customsearch_Result extends Analytify_Google_Collection
{
  public $cacheId;
  public $displayLink;
  public $fileFormat;
  ...
  public $htmlSnippet;
  public $htmlTitle;
  protected $imageType = 'Analytify_Google_Service_Customsearch_ResultImage';
  protected $imageDataType = '';
  public $kind;
  protected $labelsType = 'Analytify_Google_Service_Customsearch_ResultLabels';
  ...
  public function setImage(Analytify_Google_Service_Customsearch_ResultImage $image)
  {
    $this->image = $image;
  }
...
class Analytify_Google_Service_Customsearch_ResultImage extends Analytify_Google_Model
{
  public $byteSize;
  public $contextLink;
  public $height;
...
class Analytify_Google_Service_Customsearch_ResultLabels extends Analytify_Google_Model
{
  public $displayName;
  public $labelWithOp;
  public $name;
...
class Analytify_Google_Service_Customsearch_ResultPagemap extends Analytify_Google_Model
{

}

class Analytify_Google_Service_Customsearch_ResultPagemapItemElement extends Analytify_Google_Model
{

}

class Analytify_Google_Service_Customsearch_Search extends Analytify_Google_Collection
{
  protected $contextType = 'Analytify_Google_Service_Customsearch_Context';
  protected $contextDataType = '';
  protected $itemsType = 'Analytify_Google_Service_Customsearch_Result';
  protected $itemsDataType = 'array';
  public $kind;
  protected $promotionsType = 'Analytify_Google_Service_Customsearch_Promotion';
  protected $promotionsDataType = 'array';
  protected $queriesType = 'Analytify_Google_Service_Customsearch_Query';
  protected $queriesDataType = 'map';
  protected $searchInformationType = 'Analytify_Google_Service_Customsearch_SearchSearchInformation';
  protected $searchInformationDataType = '';
  protected $spellingType = 'Analytify_Google_Service_Customsearch_SearchSpelling';
  protected $spellingDataType = '';
  protected $urlType = 'Analytify_Google_Service_Customsearch_SearchUrl';
  protected $urlDataType = '';

  public function setContext(Analytify_Google_Service_Customsearch_Context $context)
  {
  ...
  public function setSearchInformation(Analytify_Google_Service_Customsearch_SearchSearchInformation $searchInformation)
  {
  ...
  public function setSpelling(Analytify_Google_Service_Customsearch_SearchSpelling $spelling)
  {
  ...
  public function setUrl(Analytify_Google_Service_Customsearch_SearchUrl $url)
  {
    $this->url = $url;
  }
...
class Analytify_Google_Service_Customsearch_SearchQueries extends Analytify_Google_Model
{

}

class Analytify_Google_Service_Customsearch_SearchSearchInformation extends Analytify_Google_Model
{
...
class Analytify_Google_Service_Customsearch_SearchSpelling extends Analytify_Google_Model
{
...
class Analytify_Google_Service_Customsearch_SearchUrl extends Analytify_Google_Model
{
  public $template;
  public $type;
