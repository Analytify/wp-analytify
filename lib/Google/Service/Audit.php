 ...
 * @author Google, Inc.
 */
class Analytify_Google_Service_Audit extends Analytify_Google_Service
{
  ...
  public function __construct(Analytify_Google_Client $client)
  {
    ...
    $this->activities = new Analytify_Google_Service_Audit_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $auditService = new Analytify_Google_Service_Audit(...);
 *   $activities = $auditService->activities;
 *  </code>
 */
class Analytify_Google_Service_Audit_Activities_Resource extends Analytify_Google_Service_Resource
{
   ...
   * Next page URL.
   * @return Analytify_Google_Service_Audit_Activities
   */
  public function listActivities($customerId, $applicationId, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "Analytify_Google_Service_Audit_Activities");
  }
}
...
class Analytify_Google_Service_Audit_Activities extends Analytify_Google_Collection
{
  protected $itemsType = 'Analytify_Google_Service_Audit_Activity';
...
class Analytify_Google_Service_Audit_Activity extends Analytify_Google_Collection
{
  protected $actorType = 'Analytify_Google_Service_Audit_ActivityActor';
  protected $actorDataType = '';
  protected $eventsType = 'Analytify_Google_Service_Audit_ActivityEvents';
  protected $eventsDataType = 'array';
  protected $idType = 'Analytify_Google_Service_Audit_ActivityId';
  protected $idDataType = '';
  public $ipAddress;
  public $kind;
  public $ownerDomain;

  public function setActor(Analytify_Google_Service_Audit_ActivityActor $actor)
  {
    $this->actor = $actor;
  }
  ...
  public function setId(Analytify_Google_Service_Audit_ActivityId $id)
  {
    $this->id = $id;
  }
...
class Analytify_Google_Service_Audit_ActivityActor extends Analytify_Google_Model
{
...
class Analytify_Google_Service_Audit_ActivityEvents extends Analytify_Google_Collection
{
  public $eventType;
  public $name;
  protected $parametersType = 'Analytify_Google_Service_Audit_ActivityEventsParameters';
...
class Analytify_Google_Service_Audit_ActivityEventsParameters extends Analytify_Google_Model
{
  public $name;
  public $value;
...
class Analytify_Google_Service_Audit_ActivityId extends Analytify_Google_Model
{
  public $applicationId;
  public $customerId;
  public $time;
