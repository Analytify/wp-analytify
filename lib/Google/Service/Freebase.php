 ...
 * @author Google, Inc.
 */
class Analytify_Google_Service_Freebase extends Analytify_Google_Service
{
  ...
  public function __construct(Analytify_Google_Client $client)
  {
    ...
    $this->base_methods = new Analytify_Google_Service_Resource(
        $this,
        $this->serviceName,
        '',
        array(
   ...
   * @return Analytify_Google_Service_Freebase_ReconcileGet
   */
  public function reconcile($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('reconcile', array($params), "Analytify_Google_Service_Freebase_ReconcileGet");
  }
  /**
...
class Analytify_Google_Service_Freebase_ReconcileCandidate extends Analytify_Google_Model
{
  public $confidence;
  public $lang;
  public $mid;
  public $name;
  protected $notableType = 'Analytify_Google_Service_Freebase_ReconcileCandidateNotable';
  ...
  public function setNotable(Analytify_Google_Service_Freebase_ReconcileCandidateNotable $notable)
  {
...
class Analytify_Google_Service_Freebase_ReconcileCandidateNotable extends Analytify_Google_Model
{
  public $id;
  public $name;
...
class Analytify_Google_Service_Freebase_ReconcileGet extends Analytify_Google_Collection
{
  protected $candidateType = 'Analytify_Google_Service_Freebase_ReconcileCandidate';
  protected $candidateDataType = 'array';
  protected $costsType = 'Analytify_Google_Service_Freebase_ReconcileGetCosts';
  protected $costsDataType = '';
  protected $matchType = 'Analytify_Google_Service_Freebase_ReconcileCandidate';
  protected $matchDataType = '';
  protected $warningType = 'Analytify_Google_Service_Freebase_ReconcileGetWarning';
  ...
  public function setCosts(Analytify_Google_Service_Freebase_ReconcileGetCosts $costs)
  {
    $this->costs = $costs;
  }
  ...
  public function setMatch(Analytify_Google_Service_Freebase_ReconcileCandidate $match)
  {
    $this->match = $match;
  }
...
class Analytify_Google_Service_Freebase_ReconcileGetCosts extends Analytify_Google_Model
{
  public $hits;
  public $ms;
...
class Analytify_Google_Service_Freebase_ReconcileGetWarning extends Analytify_Google_Model
{
  public $location;
  public $message;
  public $reason;
