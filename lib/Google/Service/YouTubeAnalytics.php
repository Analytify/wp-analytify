 ...
 * @author Google, Inc.
 */
class Analytify_Google_Service_YouTubeAnalytics extends Analytify_Google_Service
{
  ...
  public function __construct(Analytify_Google_Client $client)
  {
    ...
    $this->batchReportDefinitions = new Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource(
        $this,
        $this->serviceName,
    ...
    $this->batchReports = new Analytify_Google_Service_YouTubeAnalytics_BatchReports_Resource(
        $this,
        $this->serviceName,
        'batchReports',
        array(
    ...
    $this->reports = new Analytify_Google_Service_YouTubeAnalytics_Reports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $youtubeAnalyticsService = new Analytify_Google_Service_YouTubeAnalytics(...);
 *   $batchReportDefinitions = $youtubeAnalyticsService->batchReportDefinitions;
 *  </code>
 */
class Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource extends Analytify_Google_Service_Resource
{
   ...
   * @return Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitionList
   */
  public function listBatchReportDefinitions($onBehalfOfContentOwner, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitionList");
  }
}
 ...
 *  </code>
 */
class Analytify_Google_Service_YouTubeAnalytics_BatchReports_Resource extends Analytify_Google_Service_Resource
{
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of.
   * @param array $optParams Optional parameters.
   * @return Analytify_Google_Service_YouTubeAnalytics_BatchReportList
   */
  public function listBatchReports($batchReportDefinitionId, $onBehalfOfContentOwner, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Analytify_Google_Service_YouTubeAnalytics_BatchReportList");
  }
}
 ...
 *  </code>
 */
class Analytify_Google_Service_YouTubeAnalytics_Reports_Resource extends Analytify_Google_Service_Resource
{
   ...
   * @return Analytify_Google_Service_YouTubeAnalytics_ResultTable
   */
  public function query($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Analytify_Google_Service_YouTubeAnalytics_ResultTable");
  }
}
...
class Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitionList extends Analytify_Google_Collection
{
  protected $itemsType = 'Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplate';
...
class Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplate extends Analytify_Google_Collection
{
  protected $defaultOutputType = 'Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplateDefaultOutput';
...
class Analytify_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplateDefaultOutput extends Analytify_Google_Model
{
  public $format;
  public $type;
...
class Analytify_Google_Service_YouTubeAnalytics_BatchReportList extends Analytify_Google_Collection
{
  protected $itemsType = 'Analytify_Google_Service_YouTubeAnalytics_BatchReportTemplate';
  protected $itemsDataType = 'array';
  public $kind;
...
class Analytify_Google_Service_YouTubeAnalytics_BatchReportTemplate extends Analytify_Google_Collection
{
  public $id;
  protected $outputsType = 'Analytify_Google_Service_YouTubeAnalytics_BatchReportTemplateOutputs';
  protected $outputsDataType = 'array';
  public $reportId;
  protected $timeSpanType = 'Analytify_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan';
  ...
  public function setTimeSpan(Analytify_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan $timeSpan)
  {
...
class Analytify_Google_Service_YouTubeAnalytics_BatchReportTemplateOutputs extends Analytify_Google_Model
{
  public $downloadUrl;
  public $format;
  public $type;
...
class Analytify_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan extends Analytify_Google_Model
{
  public $endTime;
  public $startTime;
...
class Analytify_Google_Service_YouTubeAnalytics_ResultTable extends Analytify_Google_Collection
{
  protected $columnHeadersType = 'Analytify_Google_Service_YouTubeAnalytics_ResultTableColumnHeaders';
...
class Analytify_Google_Service_YouTubeAnalytics_ResultTableColumnHeaders extends Analytify_Google_Model
{
  public $columnType;
  public $dataType;
  public $name;
