 ...
 * @author Google, Inc.
 */
class Analytify_Google_Service_CivicInfo extends Analytify_Google_Service
{
  ...
  public function __construct(Analytify_Google_Client $client)
  {
    ...
    $this->divisions = new Analytify_Google_Service_CivicInfo_Divisions_Resource(
        $this,
        $this->serviceName,
        'divisions',
        array(
    ...
    $this->elections = new Analytify_Google_Service_CivicInfo_Elections_Resource(
        $this,
        $this->serviceName,
        'elections',
        array(
    ...
    $this->representatives = new Analytify_Google_Service_CivicInfo_Representatives_Resource(
        $this,
        $this->serviceName,
        'representatives',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $civicinfoService = new Analytify_Google_Service_CivicInfo(...);
 *   $divisions = $civicinfoService->divisions;
 *  </code>
 */
class Analytify_Google_Service_CivicInfo_Divisions_Resource extends Analytify_Google_Service_Resource
{
   ...
   * @return Analytify_Google_Service_CivicInfo_DivisionSearchResponse
   */
  public function search($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Analytify_Google_Service_CivicInfo_DivisionSearchResponse");
  }
}
 ...
 *  </code>
 */
class Analytify_Google_Service_CivicInfo_Elections_Resource extends Analytify_Google_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Analytify_Google_Service_CivicInfo_ElectionsQueryResponse
   */
  public function electionQuery($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('electionQuery', array($params), "Analytify_Google_Service_CivicInfo_ElectionsQueryResponse");
  }
  /**
   ...
   * @param Analytify_Google_VoterInfoRequest $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool officialOnly
   * If set to true, only data from official state sources will be returned.
   * @return Analytify_Google_Service_CivicInfo_VoterInfoResponse
   */
  public function voterInfoQuery($electionId, Analytify_Google_Service_CivicInfo_VoterInfoRequest $postBody, $optParams = array())
  {
    $params = array('electionId' => $electionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('voterInfoQuery', array($params), "Analytify_Google_Service_CivicInfo_VoterInfoResponse");
  }
}
 ...
 *  </code>
 */
class Analytify_Google_Service_CivicInfo_Representatives_Resource extends Analytify_Google_Service_Resource
{
   ...
   *
   * @param Analytify_Google_RepresentativeInfoRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Analytify_Google_Service_CivicInfo_RepresentativeInfoResponse
   */
  public function representativeInfoQuery(Analytify_Google_Service_CivicInfo_RepresentativeInfoRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoQuery', array($params), "Analytify_Google_Service_CivicInfo_RepresentativeInfoResponse");
  }
}
...
class Analytify_Google_Service_CivicInfo_AdministrationRegion extends Analytify_Google_Collection
{
  protected $electionAdministrationBodyType = 'Analytify_Google_Service_CivicInfo_AdministrativeBody';
  protected $electionAdministrationBodyDataType = '';
  public $id;
  protected $localJurisdictionType = 'Analytify_Google_Service_CivicInfo_AdministrationRegion';
  protected $localJurisdictionDataType = '';
  public $name;
  protected $sourcesType = 'Analytify_Google_Service_CivicInfo_Source';
  protected $sourcesDataType = 'array';

  public function setElectionAdministrationBody(Analytify_Google_Service_CivicInfo_AdministrativeBody $electionAdministrationBody)
  {
  ...
  public function setLocalJurisdiction(Analytify_Google_Service_CivicInfo_AdministrationRegion $localJurisdiction)
  {
...
class Analytify_Google_Service_CivicInfo_AdministrativeBody extends Analytify_Google_Collection
{
  public $absenteeVotingInfoUrl;
  public $ballotInfoUrl;
  protected $correspondenceAddressType = 'Analytify_Google_Service_CivicInfo_SimpleAddressType';
  protected $correspondenceAddressDataType = '';
  public $electionInfoUrl;
  protected $electionOfficialsType = 'Analytify_Google_Service_CivicInfo_ElectionOfficial';
  ...
  public $name;
  protected $physicalAddressType = 'Analytify_Google_Service_CivicInfo_SimpleAddressType';
  ...
  public function setCorrespondenceAddress(Analytify_Google_Service_CivicInfo_SimpleAddressType $correspondenceAddress)
  {
  ...
  public function setPhysicalAddress(Analytify_Google_Service_CivicInfo_SimpleAddressType $physicalAddress)
  {
...
class Analytify_Google_Service_CivicInfo_Candidate extends Analytify_Google_Collection
{
  public $candidateUrl;
  protected $channelsType = 'Analytify_Google_Service_CivicInfo_Channel';
...
class Analytify_Google_Service_CivicInfo_Channel extends Analytify_Google_Model
{
  public $id;
  public $type;
...
class Analytify_Google_Service_CivicInfo_Contest extends Analytify_Google_Collection
{
  public $ballotPlacement;
  protected $candidatesType = 'Analytify_Google_Service_CivicInfo_Candidate';
  protected $candidatesDataType = 'array';
  protected $districtType = 'Analytify_Google_Service_CivicInfo_ElectoralDistrict';
  ...
  public function setDistrict(Analytify_Google_Service_CivicInfo_ElectoralDistrict $district)
  {
...
class Analytify_Google_Service_CivicInfo_DivisionSearchResponse extends Analytify_Google_Collection
{
  public $kind;
  protected $resultsType = 'Analytify_Google_Service_CivicInfo_DivisionSearchResult';
...
class Analytify_Google_Service_CivicInfo_DivisionSearchResult extends Analytify_Google_Collection
{
  public $aliases;
  public $name;
  public $ocdId;
...
class Analytify_Google_Service_CivicInfo_Election extends Analytify_Google_Model
{
  public $electionDay;
  public $id;
  public $name;
...
class Analytify_Google_Service_CivicInfo_ElectionOfficial extends Analytify_Google_Model
{
  public $emailAddress;
  public $faxNumber;
  public $name;
...
class Analytify_Google_Service_CivicInfo_ElectionsQueryResponse extends Analytify_Google_Collection
{
  protected $electionsType = 'Analytify_Google_Service_CivicInfo_Election';
...
class Analytify_Google_Service_CivicInfo_ElectoralDistrict extends Analytify_Google_Model
{
  public $id;
  public $name;
  public $scope;
...
class Analytify_Google_Service_CivicInfo_GeographicDivision extends Analytify_Google_Collection
{
  public $alsoKnownAs;
  public $name;
  public $officeIds;
...
class Analytify_Google_Service_CivicInfo_Office extends Analytify_Google_Collection
{
  public $divisionId;
  public $level;
  public $name;
...
class Analytify_Google_Service_CivicInfo_Official extends Analytify_Google_Collection
{
  protected $addressType = 'Analytify_Google_Service_CivicInfo_SimpleAddressType';
...
class Analytify_Google_Service_CivicInfo_PollingLocation extends Analytify_Google_Collection
{
  protected $addressType = 'Analytify_Google_Service_CivicInfo_SimpleAddressType';
  ...
  public function setAddress(Analytify_Google_Service_CivicInfo_SimpleAddressType $address)
  {
    $this->address = $address;
  }
...
class Analytify_Google_Service_CivicInfo_RepresentativeInfoRequest extends Analytify_Google_Model
{
  public $address;
...
class Analytify_Google_Service_CivicInfo_RepresentativeInfoResponse extends Analytify_Google_Model
{
  protected $divisionsType = 'Analytify_Google_Service_CivicInfo_GeographicDivision';
  protected $divisionsDataType = 'map';
  public $kind;
  protected $normalizedInputType = 'Analytify_Google_Service_CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $officesType = 'Analytify_Google_Service_CivicInfo_Office';
  protected $officesDataType = 'map';
  protected $officialsType = 'Analytify_Google_Service_CivicInfo_Official';
  ...
  public function setNormalizedInput(Analytify_Google_Service_CivicInfo_SimpleAddressType $normalizedInput)
  {
...
class Analytify_Google_Service_CivicInfo_RepresentativeInfoResponseDivisions extends Analytify_Google_Model
{

}

class Analytify_Google_Service_CivicInfo_RepresentativeInfoResponseOffices extends Analytify_Google_Model
{

}

class Analytify_Google_Service_CivicInfo_RepresentativeInfoResponseOfficials extends Analytify_Google_Model
{

}

class Analytify_Google_Service_CivicInfo_SimpleAddressType extends Analytify_Google_Model
{
  public $city;
  public $line1;
  public $line2;
...
class Analytify_Google_Service_CivicInfo_Source extends Analytify_Google_Model
{
  public $name;
  public $official;
...
class Analytify_Google_Service_CivicInfo_VoterInfoRequest extends Analytify_Google_Model
{
  public $address;
...
class Analytify_Google_Service_CivicInfo_VoterInfoResponse extends Analytify_Google_Collection
{
  protected $contestsType = 'Analytify_Google_Service_CivicInfo_Contest';
  protected $contestsDataType = 'array';
  protected $earlyVoteSitesType = 'Analytify_Google_Service_CivicInfo_PollingLocation';
  protected $earlyVoteSitesDataType = 'array';
  protected $electionType = 'Analytify_Google_Service_CivicInfo_Election';
  protected $electionDataType = '';
  public $kind;
  protected $normalizedInputType = 'Analytify_Google_Service_CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $pollingLocationsType = 'Analytify_Google_Service_CivicInfo_PollingLocation';
  protected $pollingLocationsDataType = 'array';
  protected $stateType = 'Analytify_Google_Service_CivicInfo_AdministrationRegion';
  ...
  public function setElection(Analytify_Google_Service_CivicInfo_Election $election)
  {
