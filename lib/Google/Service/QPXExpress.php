 ...
 * @author Google, Inc.
 */
class Analytify_Google_Service_QPXExpress extends Analytify_Google_Service
{
  ...
  public function __construct(Analytify_Google_Client $client)
  {
    ...
    $this->trips = new Analytify_Google_Service_QPXExpress_Trips_Resource(
        $this,
        $this->serviceName,
        'trips',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $qpxExpressService = new Analytify_Google_Service_QPXExpress(...);
 *   $trips = $qpxExpressService->trips;
 *  </code>
 */
class Analytify_Google_Service_QPXExpress_Trips_Resource extends Analytify_Google_Service_Resource
{

  /**
   * Returns a list of flights. (trips.search)
   *
   * @param Analytify_Google_TripsSearchRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Analytify_Google_Service_QPXExpress_TripsSearchResponse
   */
  public function search(Analytify_Google_Service_QPXExpress_TripsSearchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Analytify_Google_Service_QPXExpress_TripsSearchResponse");
  }
}
...
class Analytify_Google_Service_QPXExpress_AircraftData extends Analytify_Google_Model
{
  public $code;
  public $kind;
  public $name;
...
class Analytify_Google_Service_QPXExpress_AirportData extends Analytify_Google_Model
{
  public $city;
  public $code;
  public $kind;
...
class Analytify_Google_Service_QPXExpress_BagDescriptor extends Analytify_Google_Collection
{
...
class Analytify_Google_Service_QPXExpress_CarrierData extends Analytify_Google_Model
{
  public $code;
  public $kind;
  public $name;
...
class Analytify_Google_Service_QPXExpress_CityData extends Analytify_Google_Model
{
  public $code;
  public $country;
  public $kind;
...
class Analytify_Google_Service_QPXExpress_Data extends Analytify_Google_Collection
{
  protected $aircraftType = 'Analytify_Google_Service_QPXExpress_AircraftData';
  protected $aircraftDataType = 'array';
  protected $airportType = 'Analytify_Google_Service_QPXExpress_AirportData';
  protected $airportDataType = 'array';
  protected $carrierType = 'Analytify_Google_Service_QPXExpress_CarrierData';
  protected $carrierDataType = 'array';
  protected $cityType = 'Analytify_Google_Service_QPXExpress_CityData';
  protected $cityDataType = 'array';
  public $kind;
  protected $taxType = 'Analytify_Google_Service_QPXExpress_TaxData';
...
class Analytify_Google_Service_QPXExpress_FareInfo extends Analytify_Google_Model
{
  public $basisCode;
  public $carrier;
  public $destination;
...
class Analytify_Google_Service_QPXExpress_FlightInfo extends Analytify_Google_Model
{
  public $carrier;
  public $number;
...
class Analytify_Google_Service_QPXExpress_FreeBaggageAllowance extends Analytify_Google_Collection
{
  protected $bagDescriptorType = 'Analytify_Google_Service_QPXExpress_BagDescriptor';
...
class Analytify_Google_Service_QPXExpress_LegInfo extends Analytify_Google_Model
{
  public $aircraft;
  public $arrivalTime;
  public $changePlane;
...
class Analytify_Google_Service_QPXExpress_PassengerCounts extends Analytify_Google_Model
{
  public $adultCount;
  public $childCount;
...
class Analytify_Google_Service_QPXExpress_PricingInfo extends Analytify_Google_Collection
{
  public $baseFareTotal;
  protected $fareType = 'Analytify_Google_Service_QPXExpress_FareInfo';
  protected $fareDataType = 'array';
  public $fareCalculation;
  public $kind;
  public $latestTicketingTime;
  protected $passengersType = 'Analytify_Google_Service_QPXExpress_PassengerCounts';
  ...
  public $saleTaxTotal;
  public $saleTotal;
  protected $segmentPricingType = 'Analytify_Google_Service_QPXExpress_SegmentPricing';
  protected $segmentPricingDataType = 'array';
  protected $taxType = 'Analytify_Google_Service_QPXExpress_TaxInfo';
  protected $taxDataType = 'array';
  ...
  public function setPassengers(Analytify_Google_Service_QPXExpress_PassengerCounts $passengers)
  {
...
class Analytify_Google_Service_QPXExpress_SegmentInfo extends Analytify_Google_Collection
{
  public $bookingCode;
  ...
  public $connectionDuration;
  public $duration;
  protected $flightType = 'Analytify_Google_Service_QPXExpress_FlightInfo';
  protected $flightDataType = '';
  public $id;
  public $kind;
  protected $legType = 'Analytify_Google_Service_QPXExpress_LegInfo';
  ...
  public function setFlight(Analytify_Google_Service_QPXExpress_FlightInfo $flight)
  {
    $this->flight = $flight;
  }
...
class Analytify_Google_Service_QPXExpress_SegmentPricing extends Analytify_Google_Collection
{
  public $fareId;
  protected $freeBaggageOptionType = 'Analytify_Google_Service_QPXExpress_FreeBaggageAllowance';
...
class Analytify_Google_Service_QPXExpress_SliceInfo extends Analytify_Google_Collection
{
  public $duration;
  public $kind;
  protected $segmentType = 'Analytify_Google_Service_QPXExpress_SegmentInfo';
...
class Analytify_Google_Service_QPXExpress_SliceInput extends Analytify_Google_Collection
{
  public $alliance;
  public $date;
  public $destination;
  ...
  protected $permittedDepartureTimeType = 'Analytify_Google_Service_QPXExpress_TimeOfDayRange';
  ...
  public function setPermittedDepartureTime(Analytify_Google_Service_QPXExpress_TimeOfDayRange $permittedDepartureTime)
  {
...
class Analytify_Google_Service_QPXExpress_TaxData extends Analytify_Google_Model
{
  public $id;
  public $kind;
  public $name;
...
class Analytify_Google_Service_QPXExpress_TaxInfo extends Analytify_Google_Model
{
  public $chargeType;
  public $code;
  public $country;
...
class Analytify_Google_Service_QPXExpress_TimeOfDayRange extends Analytify_Google_Model
{
  public $earliestTime;
  public $kind;
  public $latestTime;
...
class Analytify_Google_Service_QPXExpress_TripOption extends Analytify_Google_Collection
{
  public $id;
  public $kind;
  protected $pricingType = 'Analytify_Google_Service_QPXExpress_PricingInfo';
  protected $pricingDataType = 'array';
  public $saleTotal;
  protected $sliceType = 'Analytify_Google_Service_QPXExpress_SliceInfo';
...
class Analytify_Google_Service_QPXExpress_TripOptionsRequest extends Analytify_Google_Collection
{
  public $maxPrice;
  protected $passengersType = 'Analytify_Google_Service_QPXExpress_PassengerCounts';
  protected $passengersDataType = '';
  public $refundable;
  public $saleCountry;
  protected $sliceType = 'Analytify_Google_Service_QPXExpress_SliceInput';
  protected $sliceDataType = 'array';
  public $solutions;
...
class Analytify_Google_Service_QPXExpress_TripOptionsResponse extends Analytify_Google_Collection
{
  protected $dataType = 'Analytify_Google_Service_QPXExpress_Data';
  protected $dataDataType = '';
  public $kind;
  public $requestId;
  protected $tripOptionType = 'Analytify_Google_Service_QPXExpress_TripOption';
  protected $tripOptionDataType = 'array';

  public function setData(Analytify_Google_Service_QPXExpress_Data $data)
  {
    $this->data = $data;
  }
...
class Analytify_Google_Service_QPXExpress_TripsSearchRequest extends Analytify_Google_Model
{
  protected $requestType = 'Analytify_Google_Service_QPXExpress_TripOptionsRequest';
  protected $requestDataType = '';

  public function setRequest(Analytify_Google_Service_QPXExpress_TripOptionsRequest $request)
  {
...
class Analytify_Google_Service_QPXExpress_TripsSearchResponse extends Analytify_Google_Model
{
  public $kind;
  protected $tripsType = 'Analytify_Google_Service_QPXExpress_TripOptionsResponse';
  ...
  public function setTrips(Analytify_Google_Service_QPXExpress_TripOptionsResponse $trips)
  {
    $this->trips = $trips;
  }
