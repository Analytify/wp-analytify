 ...
 * @author Google, Inc.
 */
class Analytify_Google_Service_Taskqueue extends Analytify_Google_Service
{
  ...
  public function __construct(Analytify_Google_Client $client)
  {
    ...
    $this->taskqueues = new Analytify_Google_Service_Taskqueue_Taskqueues_Resource(
        $this,
        $this->serviceName,
        'taskqueues',
        array(
    ...
    $this->tasks = new Analytify_Google_Service_Taskqueue_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $taskqueueService = new Analytify_Google_Service_Taskqueue(...);
 *   $taskqueues = $taskqueueService->taskqueues;
 *  </code>
 */
class Analytify_Google_Service_Taskqueue_Taskqueues_Resource extends Analytify_Google_Service_Resource
{
   ...
   * @return Analytify_Google_Service_Taskqueue_TaskQueue
   */
  public function get($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Analytify_Google_Service_Taskqueue_TaskQueue");
  }
}
 ...
 *  </code>
 */
class Analytify_Google_Service_Taskqueue_Tasks_Resource extends Analytify_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Analytify_Google_Service_Taskqueue_Task
   */
  public function get($project, $taskqueue, $task, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Analytify_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return Analytify_Google_Service_Taskqueue_Task
   */
  public function insert($project, $taskqueue, Analytify_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Analytify_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return Analytify_Google_Service_Taskqueue_Tasks
   */
  public function lease($project, $taskqueue, $numTasks, $leaseSecs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lease', array($params), "Analytify_Google_Service_Taskqueue_Tasks");
  }
  /**
   ...
   * @param array $optParams Optional parameters.
   * @return Analytify_Google_Service_Taskqueue_Tasks2
   */
  public function listTasks($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Analytify_Google_Service_Taskqueue_Tasks2");
  }
  /**
   ...
   * @return Analytify_Google_Service_Taskqueue_Task
   */
  public function patch($project, $taskqueue, $task, $newLeaseSeconds, Analytify_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Analytify_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return Analytify_Google_Service_Taskqueue_Task
   */
  public function update($project, $taskqueue, $task, $newLeaseSeconds, Analytify_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Analytify_Google_Service_Taskqueue_Task");
  }
}
...
class Analytify_Google_Service_Taskqueue_Task extends Analytify_Google_Model
{
...
class Analytify_Google_Service_Taskqueue_TaskQueue extends Analytify_Google_Model
{
  protected $aclType = 'Analytify_Google_Service_Taskqueue_TaskQueueAcl';
  protected $aclDataType = '';
  public $id;
  public $kind;
  public $maxLeases;
  protected $statsType = 'Analytify_Google_Service_Taskqueue_TaskQueueStats';
  protected $statsDataType = '';

  public function setAcl(Analytify_Google_Service_Taskqueue_TaskQueueAcl $acl)
  {
    $this->acl = $acl;
  }
  ...
  public function setStats(Analytify_Google_Service_Taskqueue_TaskQueueStats $stats)
  {
    $this->stats = $stats;
  }
...
class Analytify_Google_Service_Taskqueue_TaskQueueAcl extends Analytify_Google_Collection
{
  public $adminEmails;
...
class Analytify_Google_Service_Taskqueue_TaskQueueStats extends Analytify_Google_Model
{
...
class Analytify_Google_Service_Taskqueue_Tasks extends Analytify_Google_Collection
{
  protected $itemsType = 'Analytify_Google_Service_Taskqueue_Task';
...
class Analytify_Google_Service_Taskqueue_Tasks2 extends Analytify_Google_Collection
{
  protected $itemsType = 'Analytify_Google_Service_Taskqueue_Task';
  protected $itemsDataType = 'array';
  public $kind;
