	...
	if ( $wp_analytify->pa_check_roles( $is_access_level ) ) {
		...
		<div class="analytify_wraper <?php echo $classes ?>">
				...
				<div class="analytify_general_status analytify_general_status-gif">
					...
					<a href="https://analytify.io/upgrade-from-free" target="_blank"><img src="<?php echo plugins_url( '../assets/images/analytify_compare.gif', __FILE__ )  ?>" alt="Buy Pro" style="width:100%">
