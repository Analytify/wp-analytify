...
<form action="#" method="post" id="wp-analytify-deactivate-form">
	<div class="wp-analytify-popup-header">
		<h2><?php esc_html_e( 'Quick feedback about Analytify (Google Analytics for WordPress)', 'wp-analytify' ); ?></h2>
	</div>
	<div class="wp-analytify-popup-body">
		<h3><?php esc_html_e( 'If you have a moment, please let us know why you are deactivating:', 'wp-analytify' ); ?></h3>
		...
		<li class="wp-analytify-reason wp-analytify-reason-pro" data-input-type="" data-input-placeholder="">
			...
			<span><?php esc_html_e( 'I upgraded to Analytify Pro', 'wp-analytify' ); ?></span>
			</label>
			<div class="wp-analytify-pro-message"><?php esc_html_e( 'No need to deactivate this Analytify Core version. Pro version works as an add-on with Core version.', 'wp-analytify' ); ?></div>
		</li>
		<li class="wp-analytify-reason" data-input-type="" data-input-placeholder="">
			...
			<span><?php esc_html_e( 'I only needed the plugin for a short period', 'wp-analytify' ); ?></span>
			</label>
		...
		<li class="wp-analytify-reason has-input" data-input-type="textfield">
			...
			<span><?php esc_html_e( 'I found a better plugin', 'wp-analytify' ); ?></span>
			</label>
			<div class="wp-analytify-internal-message"></div>
			<div class="wp-analytify-reason-input"><span class="message error-message"><?php esc_html_e( 'Kindly tell us the name of plugin', 'wp-analytify' ); ?></span><input type="text" name="better_plugin" placeholder="What's the plugin's name?"></div>
		</li>
		<li class="wp-analytify-reason" data-input-type="" data-input-placeholder="">
			<label>
			<span>
			...
			<span><?php esc_html_e( 'The plugin broke my site', 'wp-analytify' ); ?></span>
			</label>
			<div class="wp-analytify-internal-message"></div>
		</li>
		<li class="wp-analytify-reason" data-input-type="" data-input-placeholder="">
			...
			<span><?php esc_html_e( 'The plugin suddenly stopped working', 'wp-analytify' ); ?></span>
			</label>
			<div class="wp-analytify-internal-message"></div>
		</li>
		<li class="wp-analytify-reason" data-input-type="" data-input-placeholder="">
			...
			<span><?php esc_html_e( 'I no longer need the plugin', 'wp-analytify' ); ?></span>
			</label>
			<div class="wp-analytify-internal-message"></div>
		</li>
		<li class="wp-analytify-reason" data-input-type="" data-input-placeholder="">
			...
			<span><?php esc_html_e( "It's a temporary deactivation. I'm just debugging an issue.", 'wp-analytify' ); ?></span>
			</label>
			<div class="wp-analytify-internal-message"></div>
		</li>
		<li class="wp-analytify-reason has-input" data-input-type="textfield" >
			...
			<span><?php esc_html_e( 'Other', 'wp-analytify' ); ?></span>
			</label>
			<div class="wp-analytify-internal-message"></div>
			<div class="wp-analytify-reason-input"><span class="message error-message "><?php esc_html_e( 'Kindly tell us the reason so we can improve.', 'wp-analytify' ); ?></span><input type="text" name="other_reason" placeholder="Would you like to share what's other reason ?"></div>
		</li>
		</ul>
	</div>
	<div class="wp-analytify-popup-footer">
		<label class="wp-analytify-anonymous"><input type="checkbox" /><?php esc_html_e( 'Anonymous feedback', 'wp-analytify' ); ?></label>
		<input type="button" class="button button-secondary button-skip wp-analytify-popup-skip-feedback" value="Skip &amp; Deactivate" >
		<div class="action-btns">
		<span class="wp-analytify-spinner"><img src="<?php echo esc_url( admin_url( '/images/spinner.gif' ) ); ?>" alt="spinner"></span>
		...
		<a href="#" class="button button-primary wp-analytify-popup-button-close"><?php esc_html_e( 'Cancel', 'wp-analytify' ); ?></a>
