...
function pa_include_pages_stats( $current, $page_stats ) {
	...
	<div class="data_boxes">
		<div class="data_boxes_title"><?php esc_html_e( 'What\'s happening when users come to your site.', 'wp-analytify' ); ?> <div class="arrow_btn"></div></div>
	...
	<div class="data_boxes_footer">
		...
		<span class="information-txt"><?php esc_html_e( 'Did you know that', 'wp-analytify' )?> <b><?php echo $current->wpa_number_format( $exit_num ); ?></b> <?php esc_html_e( ' people landed directly to your site at ', 'wp-analytify' )?> <a href="<?php echo get_option( 'pt_webprofile_url' ) . $exit_path;?>" target="_blank"><?php echo $exit_path;?></a></span>
	</div>
</div>
<?php
}
