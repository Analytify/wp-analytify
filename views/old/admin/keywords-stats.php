...
<div class="data_boxes">
		<div class="data_boxes_title"><?php esc_html_e( 'How people are finding you (keywords)', 'wp-analytify' ); ?><div class="arrow_btn"></div></div>
	  <div class="data_container">
			...
			<div class="<?php echo $class; ?> keywordscont">
			  <span class="visits_by_keyword"><?php echo $current->wpa_number_format( $k_stats[1] ); ?></span> <?php esc_html_e( 'Visits', 'wp-analytify' ); ?> <br />
	...
	<div class="data_boxes_footer">
		<span class="blk">
		  ...
		  <span class="information-txt"><?php esc_html_e( 'See which keywords are matching what users search.', 'wp-analytify' )?></span></div>
	</div>
	<?php } ?>
