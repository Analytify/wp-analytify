...
<div class="data_boxes">
	<div class="data_boxes_title"><?php esc_html_e( 'Top Countries', 'wp-analytify' ); ?> <div class="arrow_btn"></div></div>
	...
	<div class="data_boxes_footer">
		...
		<span class="information-txt"><?php esc_html_e( 'Listing statistics of top five countries.', 'wp-analytify' ); ?></span>
	</div>
</div>
<?php } ?>
