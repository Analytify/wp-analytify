...
?>
	   <div class="data_boxes">
		   <div class="data_boxes_title"><?php esc_html_e( 'Top Referrers', 'wp-analytify' ); ?><div class="arrow_btn"></div></div>
								...
								<?php foreach ( $referr_stats['rows'] as $r_stats ) : ?>
														<div class="stats">
																<div class="row-visits">
																		...
																		<?php esc_html_e( 'Visits' , 'wp-analytify' ); ?>
																</div>
	...
	<div class="data_boxes_footer">
				...
				<span class="information-txt"><?php esc_html_e( 'who are the strong Referrers to your site ?? See above.', 'wp-analytify' ); ?></span>
	</div>
</div>
<?php } ?>
