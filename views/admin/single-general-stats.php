...
function wpa_single_include_general( $current, $stats) {
?>
	...
	<div class="data_container">
			...
			<div class="grids_auto_size">
				...
				<div class="grid_data cen">
						<div class="data_value">
								...
								<div class="grid_footer cen"> <?php echo _e('The amount of time someone spends on this page.' , 'wp-analytify')?> </div>
		</div>
		...
		<div class="data_boxes_footer">
								...
								<span class="information-txt">
									<?php echo _e('Did you know that total time spent on this page is ' , 'wp-analytify')?>
									<?php
