...
if ( ! class_exists( 'WP_Analytify_Settings' ) ) {
	...
	class WP_Analytify_Settings {
		...
		function show_tabs() {
			...
			$html .= '<style type="text/css">.nav-tab-wrapper a.analytify_nav_tab {display: inline-block !important;
    border: 1px solid #ccc !important;border-bottom: 0 !important;margin-left: .5em;padding: 5px 10px;font-size: 14px;line-height: 24px;background: #e4e4e4;color: #555;text-decoration: none;margin-top: 5px;width: auto !important;}</style><div class="wpa-tab-wrapper" ><h2 class="analytify_nav_tab_wrapper nav-tab-wrapper">';
